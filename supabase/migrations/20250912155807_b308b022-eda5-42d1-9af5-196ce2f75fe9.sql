-- Insert categories for sustainable products
...
('Patagonia Organic Cotton T-Shirt', 'Made from 100% organic cotton. Fair Trade Certified sewn. Uses 84% less water than conventional cotton farming.', 35.00, 1, 'brand_product', '["https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800"]', 8.8, 3.2, '["GOTS Certified", "Fair Trade", "Organic Cotton"]', '{"organic_cotton": "100%", "water_saved_percentage": 84, "fair_trade": true}', true, 100, 1, 'new', 'active'),

('Seventh Generation Toilet Paper', 'Made from 100% recycled paper. No fragrances, dyes, or chlorine bleaching. Whitened without chemicals using an oxygen-based process.', 24.99, 3, 'brand_product', '["https://images.unsplash.com/photo-1584464491033-06628f3a6b7b?w=800"]', 8.3, 4.7, '["FSC Certified", "EPA Safer Choice", "100% Recycled"]', '{"recycled_content": "100%", "chlorine_free": true, "fragrance_free": true}', true, 120, 2, 'new', 'active')
